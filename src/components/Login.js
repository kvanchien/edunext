        ...
        <Row className="wrap-form">
          ...
          <div className="note" style={{ textAlign: "left" }}>
            <i style={{ fontSize: 10, marginLeft: "400px" }}>
              ...
              <b style={{ color: "red" }}>VPN</b> enabled. Please turn it off.
            </i>
          ...
          <Row
            style={{
              boxShadow: "rgb(229, 229, 229) 0px 0px 5px",
              padding: 15,
              marginTop: 5,
          ...
          >
            ...
            >
              Select a campus before signing in to the system with username and
              password
            </span>
              ...
              <ul className="contact-menu">
                <li style={{ listStyle: "none" }}>
                  <div className="row">
                      ...
                      <Modal show={show} onHide={handleClose} size="lg">
                        ...
                        <Modal.Body>
                          <Container>
                            <Row>
                              <h5>
                                If the login displays the message "AN ERROR HAS
                                OCCURRED," please verify the system's time
                                settings according to GMT+07:00.
                              </h5>
                            </Row>
                            <Row>
                              <i className="text-danger">
                                Hãy chắc chắn rằng thời gian trên đồng hồ của hệ
                                thống (LAPTOP hoặc PC) đồng nhất với thời gian
                                hiện tại. (Hãy xem đồng hồ trên điện thoại của
                                bạn để xác nhận lại với PC hoặc LAPTOP)
                              </i>

                              <ul>
                                <li>
                                  Checking and change time of laptop or pc to
                                  current times
                                </li>
                                <a
                            ...
                            <Row>
                              ...
                              <ul>
                                <li>
                                  Because students are added to the class late,
                                  students should ask the instructor to add
                            ...
                            <Row>
                              <h5>
                                Why lecturer can not change the setting of a CQ?
                              </h5>
                              <ul>
                                <li>
                                  Default "CQs" received from FAP which,
                                  lecturer cannot be changed
                                </li>
                                <li>
                                  The lecturer only changes the settings for
                                  "CQs" created by the lecturer himself
                                </li>
                              </ul>
                              <h5>How to create group for slot?</h5>
                              <ul>
                                <li>
                                  Groups created for a "CQ" in the same "Slot"
                                  will be assigned to all "CQs" in the same
                                  "Slot" so lecturer only need to create groups
                                  once per "Slot".
                                </li>
                                <li>
                                  To create a group of a "Slot" lecturer must
                                  click on the{" "}
                                  <b className="text-danger">"View detail"</b>{" "}
                                  then selected "CQ" and click on the "CREATE
                                  GROUP" button.
                                </li>
                              </ul>
                              <img
                    ...
                    >
                      <Button variant="" onClick={handleShowContact}>
                        <span style={{ color: "blue" }}>
                          IT HELP DESK - PHONE: +84 913677744
                        </span>
                      </Button>
